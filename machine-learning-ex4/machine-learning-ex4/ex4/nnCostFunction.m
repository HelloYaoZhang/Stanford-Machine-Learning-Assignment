...
for i = 1:m
	...
	delta2 = (Theta2' * delta3) .* [1; sigmoidGradient(y2)];
	delta2 = delta2(2:end);

	Theta1_g = Theta1_g + delta2 * a1';
	Theta2_g = Theta2_g + delta3 * a2';
end
...
Theta1(:,1) = 0;
Theta2(:,1) = 0;
Theta1_g = (1/m) * Theta1_g + lambda / m * Theta1;
Theta2_g = (1/m) * Theta2_g + lambda / m * Theta2;
